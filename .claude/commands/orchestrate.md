...
1. Read `.data/manifest.yaml` for current state (or initialize if empty/template)
...
6. Route to the appropriate gateway command (`/gateway-nix`, `/gateway-ts`, `/gateway-cross`) during phases 3 and 8
